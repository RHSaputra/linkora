...
export function renderVerificationOtpEmail({
  ...
  const content = `
    ...
    <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 24px 0 26px;">
      <tr>
        <td align="center">
          <div style="display: inline-block; background-color: #f8fafc; border: 2px dashed #cbd5e1; border-radius: 14px; padding: 18px 36px; text-align: center;">
            <span class="otp-code" style="font-family: 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, Courier, monospace; font-size: 34px; font-weight: 800; letter-spacing: 10px; color: #0f172a; display: inline-block; text-align: center;">
              ${escapeHtml(otp)}
            </span>
          </div>
        </td>
