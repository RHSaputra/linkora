    ...
    <section className="py-10 md:py-18 relative overflow-hidden bg-background">
      ...
      <div className="container px-3.5 sm:px-6 relative z-10">
        <motion.div
          ...
          className="glass-panel p-5 sm:p-12 md:p-16 rounded-xl sm:rounded-[2.5rem] text-center max-w-5xl mx-auto border border-primary/30 shadow-2xl relative overflow-hidden group"
        >
          ...
          <div className="relative z-10 space-y-4 sm:space-y-6 max-w-3xl mx-auto">
            <h2 className="text-xl sm:text-4xl md:text-5xl font-bold tracking-tight text-foreground leading-tight">
            ...
            <p className="text-xs sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              {locale === "en" ? (
            ...
            <div className="pt-1 sm:pt-2 flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-4 w-full">
              <Button size="lg" className="w-full sm:w-auto rounded-full h-10.5 sm:h-13 px-6 sm:px-8 text-xs sm:text-base bg-primary hover:bg-primary-hover text-primary-foreground shadow-2xl shadow-primary/30 active:scale-95 transition-all duration-150 hover:scale-105 cursor-pointer font-bold touch-manipulation select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" asChild>
                <Link href="/dashboard">
                  {t("landing.openDashboard")} <ArrowRight className="ml-1.5 w-3.5 h-3.5 sm:w-5 sm:h-5" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-full h-10.5 sm:h-13 px-5 sm:px-7 text-xs sm:text-base glass-panel hover:bg-foreground/5 active:scale-95 transition-all duration-150 touch-manipulation select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" asChild>
                <Link href="/login">
            ...
            <div className="pt-1 sm:pt-2 flex flex-wrap items-center justify-center gap-x-3 sm:gap-x-6 gap-y-1.5 text-[10px] sm:text-xs text-muted-foreground">
              <span className="flex items-center gap-1">
                <ShieldCheck className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400" /> {locale === "en" ? "Free to Use" : "Gratis Digunakan"}
              </span>
...
export function Footer() {
  ...
  return (
    <footer className="py-8 sm:py-10 border-t border-border/60 bg-background relative z-10 mt-auto">
      <div className="container px-3.5 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-8 mb-8 sm:mb-12">
          {/* Brand Column */}
          <div className="md:col-span-5 space-y-3 sm:space-y-4 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start">
              <img src="/linkorian.jpeg" alt="Linkorian Logo" className="h-9 sm:h-14 w-auto object-contain rounded-lg sm:rounded-xl drop-shadow-md" />
            </div>
