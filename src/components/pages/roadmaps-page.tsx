        ...
        <div className="flex items-center gap-2 flex-wrap shrink-0">
          <div className="relative inline-flex items-center justify-center p-[2px] rounded-xl overflow-hidden cursor-pointer shadow-md transition-all duration-300 hover:shadow-primary/25 active:scale-95 shrink-0">
            ...
            <Button
              ...
              className="relative z-10 bg-card hover:bg-card/90 text-foreground font-semibold h-10 px-5 rounded-[10px] shadow-xs text-xs sm:text-sm border-0 transition-colors cursor-pointer flex items-center justify-center whitespace-nowrap"
            >
