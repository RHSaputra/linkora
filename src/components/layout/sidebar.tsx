  ...
  return (
    <>
      ...
      <Dialog open={logoutDialogOpen} onOpenChange={setLogoutDialogOpen}>
        <DialogContent className="sm:max-w-[560px] md:max-w-[620px] p-6 sm:p-8 rounded-3xl border border-destructive/30 bg-white dark:bg-slate-900 shadow-2xl backdrop-blur-2xl space-y-5">
